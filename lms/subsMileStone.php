...
function initializeSCO() {
	...
	writeElement('cmi.core.session_time','test');
	...
	$newArray = array("sessionId", "courseID", "children", "score_children", "student_name", "student_id", "score_raw", "masteryscore", 
		"launch_data", "suspend_data", "lesson_location", "credit", "lesson_status", "entry", "exitcourse", "total_time", "session_time",
			"testscore");
